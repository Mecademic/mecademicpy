...
MX_ST_GET_DRIVES_INDEX_COUNT = 2099
...
robot_status_code_info = {
    ...
    RobotStatusCodeInfo(MX_ST_GET_DETECTED_DRIVES, "MX_ST_GET_DETECTED_DRIVES", is_error=False),
    MX_ST_GET_DRIVES_INDEX_COUNT:
    RobotStatusCodeInfo(MX_ST_GET_DRIVES_INDEX_COUNT, "MX_ST_GET_DRIVES_INDEX_COUNT", is_error=False),
    ...
    RobotStatusCodeInfo(MX_ST_GET_TEST_BENCH_MODE, "MX_ST_GET_TEST_BENCH_MODE", is_error=False),
    ...
    RobotStatusCodeInfo(MX_ST_RT_ABS_JOINT_POS, "MX_ST_RT_ABS_JOINT_POS", is_error=False),
