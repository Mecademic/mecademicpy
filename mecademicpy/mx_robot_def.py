...
MX_ST_NO_VBOX = 1041
MX_ST_EXT_SIM_MUST_DEACTIVATED = 1042
...
robot_status_code_info = {
    ...
    MX_ST_EXT_SIM_MUST_DEACTIVATED:
    RobotStatusCodeInfo(MX_ST_EXT_SIM_MUST_DEACTIVATED, "MX_ST_EXT_SIM_MUST_DEACTIVATED", is_error=True),
    MX_ST_CMD_FAILED:
